...
class Person:
    ...
    def describe(self):
        person_1_description = f"{self.name} is {self.age} years old."  
        return person_1_description 
        pass
...
class Student(Person):
    ...
    def describe(self):
        ...
        student_1_description = f"{description} Studies {self.major}."    
        return student_1_description  
        pass
